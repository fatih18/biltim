...
export const indexes = (_table: {
  ...
  client_submission_id: PgColumn;
    ...
    uniqueIndex("five_s_findings_client_finding_id_ux").on(_table.client_finding_id),


    index("five_s_findings_client_submission_id_idx").on(_table.client_submission_id),
...
export type FiveSFindingJSON = InferSerializedSelectModel<typeof T_FiveSFindings>;
