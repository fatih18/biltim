  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        {/* Active tables */}
        <div className="mb-6">
          <h2 className="mb-4 text-lg font-semibold text-slate-900 dark:text-slate-100">Available Tables</h2>
            ...
            {verifiableTables.map((table) => {
              ...
              return (
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm transition-all duration-300 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100"
                >
                  ...
                  <div className="relative">
                    <div className="mb-4 flex items-start justify-between">
                      ...
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-950 text-slate-600 dark:text-slate-400 transition-all group-hover:bg-indigo-500 group-hover:text-slate-900 group-hover:dark:text-white">
