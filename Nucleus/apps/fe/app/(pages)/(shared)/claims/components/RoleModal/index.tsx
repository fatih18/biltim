...
export function RoleModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div {...modal} className="w-full max-w-xl rounded-2xl bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 shadow-2xl">
        ...
        <form onSubmit={onSubmit} className="space-y-4 px-6 py-5">
          <div className="space-y-1">
            <label htmlFor="role-name" className="text-xs font-medium text-slate-800 dark:text-slate-200">
              Ad
            </label>
            <input
              id="role-name"
          ...
          <div className="space-y-1">
            <label htmlFor="role-description" className="text-xs font-medium text-slate-800 dark:text-slate-200">
              Açıklama
            </label>
            <textarea
              id="role-description"
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-slate-400 dark:border-slate-600 bg-slate-200 dark:bg-slate-800 text-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-0"
            />
            <label htmlFor="role-is-system" className="text-sm text-slate-800 dark:text-slate-200">
