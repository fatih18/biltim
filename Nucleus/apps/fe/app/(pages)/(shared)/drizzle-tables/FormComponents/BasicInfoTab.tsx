  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="grid grid-cols-2 gap-6">
        <div>
          <label htmlFor="tableName" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-700 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
      ...
      <div className="grid grid-cols-3 gap-6">
        <div>
          <label htmlFor="defaultOrderBy" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
            Default Order By
          </label>
          <input
            id="defaultOrderBy"
        ...
        <div>
          <label htmlFor="orderDirection" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
            Order Direction
          </label>
          <select
            id="orderDirection"
        ...
        <div>
          <label htmlFor="maxLimit" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
            Max Limit
          </label>
          <input
            id="maxLimit"
      ...
      <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
        <label htmlFor="isFormData" className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Is Form Data</span>
        </label>
      </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {GENERIC_METHOD_OPTIONS.map((method) => {
            ...
            return (
              <label
                key={method}
                className="flex items-center gap-2 px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-lg hover:border-blue-400 cursor-pointer text-sm"
              >
                <input
                  type="checkbox"
                  checked={checked}
