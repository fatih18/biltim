  ...
  if (!users) {
    return (
      <div className="bg-white relative overflow-hidden rounded-2xl border border-slate-300 dark:border-white/10 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 text-slate-900 dark:text-white shadow-2xl">
        ...
        <div className="relative flex items-center justify-center gap-3 py-12 text-slate-800 dark:text-slate-200">
                ...
                <tr key={user.id} className="transition-colors hover:bg-slate-100 hover:dark:bg-white/5">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <div className="flex items-center gap-3">
                      <button
                        type="button"
                        className="inline-flex items-center gap-1 text-sm font-semibold text-slate-800 dark:text-slate-200 hover:text-slate-900 hover:dark:text-white transition-colors"
