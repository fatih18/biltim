        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="w-full max-w-lg rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-2xl md:p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div className="mt-4 space-y-3 text-xs">
                    <div>
                        <label className="mb-1 block font-medium text-slate-700 dark:text-slate-300">Denetimi Yapan</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="mb-1 block font-medium text-slate-700 dark:text-slate-300">Denetim Tarihi</label>
                        <DateInput
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                        {scoreFields.map(({ key, label }) => (
                            <div key={key}>
                                <label className="mb-1 block font-medium text-slate-700 dark:text-slate-300">{label}</label>
                                <input
                                    type="number"
                                    step="0.01"
                                    min="0"
