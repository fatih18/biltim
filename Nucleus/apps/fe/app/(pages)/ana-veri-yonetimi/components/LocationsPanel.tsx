                ...
                <div className="space-y-4 text-xs">
                    ...
                    <div ref={fmDropdownRef} className="relative">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-between gap-2 rounded-md border border-slate-300 dark:border-slate-700 bg-slate-200 dark:bg-slate-800 px-3 py-2 text-left text-xs text-slate-800 dark:text-slate-200 hover:border-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500/60"
                        >
